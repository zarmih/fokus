...
После нескольких сессий коуч предлагает нагрузку на завтра (короче / обычный / можно сложнее) и одну-две области. Это совет по ритуалу, не IQ. Подробности: [RETENTION_ADVISOR_G23.md](RETENTION_ADVISOR_G23.md).
