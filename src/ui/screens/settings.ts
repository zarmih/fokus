...
export function renderSettings(container: HTMLElement) {
  ...
  content.innerHTML = `
    ...
    <h3 class="settings-group-header">Привычка</h3>
    ...
    <h3 class="settings-group-header">Тренировка и Нагрузка</h3>
    <div class="settings-group">
      <div class="surface">
    ...
    ${profile.probeSnapshot || (profile.onboarded && !profile.calibrated) ? `
    <h3 class="settings-group-header">Оценка</h3>
    <div class="settings-group">
    ...
    <h3 class="settings-group-header">Оформление и Устройство</h3>
    <div class="settings-group">
      <div class="surface">
    ...
    <h3 class="settings-group-header">Данные и Приватность</h3>
    <div class="settings-group">
