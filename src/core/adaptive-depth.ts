...
export const ADAPTIVE_SETTINGS_COPY = {
  ...
  body: 'Fokus ведёт траекторию по пяти областям из точности, времени ответа и сложности, которые уже сохраняются после блоков. После удачного пика та же высота не предлагается сразу — даём паузу. После серии сбоев планка снижается глубже. Это не IQ и не диагноз.'
};
