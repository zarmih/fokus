...
import fractalSymmetryModule from './fractal-symmetry';
import cyberSwarmModule from './cyber-swarm';
import paradoxEngineModule from './paradox-engine';
