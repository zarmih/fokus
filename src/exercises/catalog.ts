...
export const catalog: { manifest: ExerciseManifest }[] = [
  ...
  },
  {
    manifest: {
      ...
      name: 'Кассир',
      domain: 'logic',
      skills: ['mental_calculation', 'numerical_processing'] as ExerciseManifest['skills'],
  ...
  },
  {
    manifest: {
      ...
      name: 'Синхронизация',
      domain: 'attention',
      skills: ['inhibition', 'reaction_speed'] as ExerciseManifest['skills'],
  ...
  },
  {
    manifest: {
      ...
      name: 'Бегущая сумма',
      domain: 'memory',
      skills: ['working_memory', 'mental_calculation'] as ExerciseManifest['skills'],
